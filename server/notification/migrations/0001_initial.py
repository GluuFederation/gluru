# Generated by Django 2.1 on 2018-08-09 19:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TicketUnsubscriber',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unsubscriber', models.CharField(help_text='User that has been unsubscribed from notification', max_length=20)),
