# Generated by Django 2.1 on 2018-08-08 10:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('privacy', models.CharField(blank=True, choices=[('IH', 'Inherit'), ('PU', 'Public'), ('PR', 'Private')], default='IH', max_length=2)),
        ...
        migrations.AddField(
            model_name='answer',
            name='ticket',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_answers', to='tickets.Ticket'),
        ),
    ]
